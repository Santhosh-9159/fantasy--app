...
const MyContests = () => {
  return (
    <ScrollView style={{width:"100%",padding:15,flexDirection:"column"}}>
    ...
    <LinearGradient
          ...
          start={{ x: 0, y: 0 }}
            ...
            <View style={{width:'97%',flexDirection:"row",display:"flex",justifyContent:"space-between",alignItems:"center",padding:10}}>
            <View style={{flexDirection:"row",gap:14}}>
         <View>
          <Image source={require('../../../../assets/WinningsTrophy.png')} style={{height:50,width:50}}/>
         </View>
         <View style={{flexDirection:"column"}}>
           <Text style={{color:"#fff",fontWeight:"bold"}}>Congratulations</Text>
           <Text style={{color:"#fff"}}>You’ve won in 1 Contest</Text>
         </View>
      </View>
      
      <View>
        <Text  style={{color:"#fff",fontWeight:"bold",fontSize:16}}>₹1000</Text>
      </View>
            </View>
    ...
    <View style={{width:'100%',flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",paddingTop:15}}>
    <View style={{width:"100%",display:"flex",flexDirection:"column",justifyContent:"center",gap:10,borderWidth:1,borderRadius:10,borderColor:"#BCBCBC"}}>
...
<View style={{flexDirection:"column"}}>
<View style={{flexDirection:"row",width:"100%",display:"flex",justifyContent:"flex-start",backgroundColor:"#EBEBEB"}}>
  <View style={{flexDirection:"row",width:"70%",display:"flex",justifyContent:"space-between",paddingLeft:10}}>
...
<View style={{flexDirection:"row",width:"100%",display:"flex",justifyContent:"space-between",backgroundColor:"#E4E8FF",alignItems:"center"}} >
    <View style={{flexDirection:"column",gap:6,paddingLeft:10,padding:5}}>
