  ...
  return (
    ...
    <View style={{width:"100%",display:"flex",flexDirection:"row",justifyContent:"center",paddingTop:10,borderBottomWidth:1,borderBottomColor:"#CCCCCC",padding:10}}>
     <View style={{width:"96%",flexDirection:"row"}}>
        <View style={{width:"25%"}}>
            <View>
                <Image source={require('../../assets/LevelUp.png')} style={{height:55,width:55}}/>
            </View>
        </View>
        <View style={{width:"75%",flexDirection:"column",gap:5}}>
           <View style={{flexDirection:"row",width:"100%",display:"flex",justifyContent:"space-between"}}>
           ...
           <View>
             <Text style={{fontSize:13}}>You showed your skills, You’ve leveled up from Silver to Gold tier.</Text>
           </View>
        </View>
    ...
    <View style={{width:"100%",display:"flex",flexDirection:"row",justifyContent:"center",paddingTop:10,borderBottomWidth:1,borderBottomColor:"#CCCCCC",padding:10}}>
     <View style={{width:"96%",flexDirection:"row"}}>
        <View style={{width:"25%"}}>
            <View>
                <Image source={require('../../assets/Deposit.png')} style={{height:55,width:55}}/>
            </View>
        </View>
        <View style={{width:"75%",flexDirection:"column",gap:5}}>
           <View style={{flexDirection:"row",width:"100%",display:"flex",justifyContent:"space-between"}}>
           ...
           <View>
             <Text style={{fontSize:13}}>Hi Shivam, Your deposit of ₹100 has been successfull</Text>
           </View>
        </View>
    ...
    <View style={{width:"100%",display:"flex",flexDirection:"row",justifyContent:"center",paddingTop:10,borderBottomWidth:1,borderBottomColor:"#CCCCCC",padding:10}}>
     <View style={{width:"96%",flexDirection:"row"}}>
        <View style={{width:"25%"}}>
            <View>
                <Image source={require('../../assets/Winnings.png')} style={{height:55,width:55}}/>
            </View>
        </View>
        <View style={{width:"75%",flexDirection:"column",gap:5}}>
           <View style={{flexDirection:"row",width:"100%",display:"flex",justifyContent:"space-between"}}>
           ...
           <View>
             <Text style={{fontSize:13}}>You won ₹1000 is last series, Join more contest and continue winning more.</Text>
           </View>
        </View>
