...
import { MaterialIcons } from '@expo/vector-icons';
  ...
  const SelectImpactPlayer = () => {
    const [ImpactPlayer, setImpactPlayer] = useState(false);
    ...
    return (
      <View>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Text style={{ color: "#fff", fontSize: 10 }}>CSK</Text>
                  </View>
                </View>
                ...
                >
                  <Text style={{ fontWeight: "bold" }}>MS DHONI</Text>
              ...
              >
                ...
                {
                  Symbol ?  <AntDesign name="minussquareo" size={24} color="#faba19" />:<Feather name="plus-square" size={24} color="green" />
        ...
        >
          ...
          <Pressable onPress={()=>navigation.navigate("SelectImpactPlayer")}
