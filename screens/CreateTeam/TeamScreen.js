      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            <Text style={{ color: '#fff',paddingRight:5,fontWeight:"bold",fontSize:14 }}>TEAM PREVIEW</Text>
          </Pressable>
          ...
          >
            <Text style={{ color: '#fff',paddingLeft:5,fontWeight:"bold",fontSize:14 }}>NEXT</Text>
