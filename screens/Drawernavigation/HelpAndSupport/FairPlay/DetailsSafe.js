          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Is it safe to add my details & documents in
                    Impact11?</Text>
                    <Text>Our users trust us with their personal documents like PAN Cards and BANK details. We value & uphold that trust in high esteem. The information shared with us is only used for user verification purposes and is never disclosed to any outside parties.</Text>
                 </View>
