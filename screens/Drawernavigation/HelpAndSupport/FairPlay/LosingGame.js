          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Losing the Game Intentionally</Text>
                    <Text>Any user who engages in, participates in, assists in or displays behaviour of intentionally losing at any game or match to withdraw winnings, will be interpreted as having unfair methods of participation. The user will be subject to immediate termination of Impact11 services.</Text>
                 </View>
