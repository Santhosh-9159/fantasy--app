          ...
          <View style={{width: wp("90%"),flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:hp(2.3)}}>What is Impact11?</Text>
                    <Text>Impact11 is upcoming fantasy sports gaming platform which enables user to use their skills and knowledge about the sports like cricket, football and create virtual fantasy team and win real money.</Text>
                 </View>
