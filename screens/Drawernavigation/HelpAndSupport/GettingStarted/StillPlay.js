          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>I don't know much about Cricket/football can I still play?</Text>
                    <Text>Impact11 is the fantasy gaming platform for everyone including those who don’t know much about cricket. So, yes, you can play even if you don’t know much about cricket/football. We have given “How to Play” section on Impact11 which can assist you in playing the game.</Text>
                 </View>
