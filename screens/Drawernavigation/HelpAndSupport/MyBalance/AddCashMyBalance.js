...
<View style={{width:"100%",flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How do I add cash to my Impact11 account?</Text>
                    <Text>You can add cash through either of the following two options:</Text>
                    <View style={{flexDirection:"column"}}>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>Click on Side Navigation menu and go the Add (or)</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>Wallet icon on the top right hand side corner</Text>
                    </View>
                    </View>
                    <View style={{flexDirection:"column"}}>
                      <Text>Next,</Text>
                      <View style={{flexDirection:"row",alignItems:"center",gap:1}}>
                        <Text>1.</Text>
                      <Text>Click on Add Cash</Text>
                    </View>
                      <View style={{flexDirection:"row",alignItems:"center",gap:1}}>
                        <Text>2.</Text>
                      <Text>Enter the 'Amount to add'</Text>
                    </View>
                      <View style={{flexDirection:"row",alignItems:"center",gap:1}}>
                        <Text>3.</Text>
                      ...
                      <View style={{flexDirection:"row",gap:1}}>
                        <Text>4.</Text>
                      <Text>Follow the on-screen instructions to complete your payment and done!</Text>
                    </View>
                      
                    </View>
                    <Text>The deposit can take a maximum of 24 hours and can be checked in the "My Recent Transactions" section.</Text>
                    
                    <View style={{flexDirection:"column"}}>
                    <Text>PS:</Text>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>If the cash hasn’t been added to your account within 24 hours, the amount will be auto-refunded to the source account</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>Effective 1 October 2023, GST will be calculated at the rate of 28% on amount deposited in your Impact11 account</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>To enhance user experience, Discount Points will also be awarded to you</Text>
                    </View>
                    </View>
                 </View>
          ...
          <LinearGradient
          style={{
            flex: 1,borderRadius:10,paddingBottom:10
          }}
          colors={["#101632", "#2A3A83", "#374DAD"]}
        >
