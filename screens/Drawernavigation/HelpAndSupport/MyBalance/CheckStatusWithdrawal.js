          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How can I check the status of my
                    withdrawal?</Text>
                    <Text>Tap the <Text style={{fontWeight:"bold"}}>Side Navigation {">"} My Balance {">"} My Transaction.</Text></Text>
                    <Text>In My Transaction go to the Withdrawal tab</Text>
                    <Text>You can check the status of all these withdrawal transactions for the last 6 months. </Text>
                    <Text>Details beyond the last 6 months can be downloaded via the 'Download' icon on the page.</Text>
                 </View>
...
export default CheckStatusWithdrawal
