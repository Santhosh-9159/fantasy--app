          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How do I manage my cards on Impact11?</Text>
                    <Text>Click on Side navigation menu and Go to My balance {">"} Manage payments.</Text>
                    <Text>You can add/remove your cards.</Text>
