          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How do I withdraw my winnings?</Text>
                    <Text>Tap the Side Navigation {">"} Withdraw {">"} Enter the amount you wish to withdraw.</Text>   
               
                   <View style={{flexDirection:"row",alignItems:"center"}}>
                     <Entypo name="dot-single" size={24} color="black" />
                     <Text>Your PAN and bank details are verified</Text> 
                    </View>                 
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                     <Entypo name="dot-single" size={24} color="black" />
                     <Text>Your winning balance is Rs. 60 or more.</Text> 
                    </View>
                    <Text>Note:</Text>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                     <Entypo name="dot-single" size={24} color="black" />
                     <Text>You can make up to 3 withdrawal requests per day.</Text> 
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                     <Entypo name="dot-single" size={24} color="black" />
                     <Text>The TDS (if applicable) and the post-tax amount that will be credited to your bank account will be detailed for you.</Text> 
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                     <Entypo name="dot-single" size={24} color="black" />
                     <Text>Each request must be at least Rs. 60 and can be up to Rs.1,00,000</Text> 
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center"}}>
                     <Entypo name="dot-single" size={24} color="black" />
                     <Text>It may take up to 3 working days for your withdrawal to be credited to your verified bank account.</Text> 
                    </View>
...
export default WithDrawWinnings
