          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>My withdrawal request is cancelled, what
                    should I do now?</Text>
                    <Text>A withdrawal request is usually cancelled if:</Text>
                    <View style={{flexDirection:"column",paddingLeft:10}}>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                       <Text>1. </Text>
                        <Text>There’s an issue with your verified bank account</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Text>2. </Text>
                        <Text>Due to a FairPlay Violation.</Text>
                        </View>
                        
                    </View>
                    <Text>The cancellation reason will be mentioned alongside the canceled transaction.</Text>
                    <Text>If the cancellation reason is 'FairPlay Violation Detected', please follow the FairPlay rules to avoid such cancellations in the future.If the cancellation reason is 'FairPlay Violation Detected', please follow the FairPlay rules to avoid such cancellations in the future. </Text>
...
export default WithdrawalRequestCancel
