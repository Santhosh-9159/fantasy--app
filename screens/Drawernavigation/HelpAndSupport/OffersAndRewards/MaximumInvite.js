...
<View style={{width:"100%",flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize:17}}>Offers & Rewards</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>What is the Maximum number of Invite I
                    can send?</Text>
                    <Text>Go to Refer & Earn Page and share your Invite link to your friends via Whatsapp, Instagram, messages or any other app</Text>
                    <Text>Your friend will get Rs.100 as Instant bonus and your will get Rs.5 upto Rs.100 when your friend plays a cash contest.</Text>
                 </View>
