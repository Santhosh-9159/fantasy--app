          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>What type of contest can I join?</Text>
                    <Text>Impact11 allows users to join various types of public and private contests on the application.</Text>
                    <Text>You can also create Private Contests and compete with your friends.</Text>
                    <Text>You can also create Private Contests and compete with your friends.</Text>
