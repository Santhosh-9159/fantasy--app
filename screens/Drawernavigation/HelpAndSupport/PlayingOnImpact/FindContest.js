          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Where can I find the contests I've joined?</Text>
                    <Text>In the 'My Matches' tab on the app home screen.</Text>

                    <View style={{flexDirection:"row",alignItems:"center",width:"100%",display:"flex"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>Before the match deadline, under the 'Upcoming' tab.</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center",width:"100%",display:"flex"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>After the match deadline, under the 'Live' tab.</Text>
                    </View>
                    <View style={{flexDirection:"row",alignItems:"center",width:"100%",display:"flex"}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text>Once the match is completed, under the 'Completed' tab.</Text>
                    </View>
                    <Text>PS: You'll see only the contests you've joined or the contests that are not abandoned.</Text>
