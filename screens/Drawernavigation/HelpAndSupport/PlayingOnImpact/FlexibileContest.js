          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>What is Flexible contest?</Text>
                    <Text>Flexible contests are paid contests that don't get cancelled even if only two teams join. Yes, that's correct.  If there are two users in the flexible contest, the respective contest will be converted into head-to-head.</Text>
                    <Text>There will be no cancellation even if all spots don't fill up.</Text>
                    <Text>Both public and private contests can be flexible contests</Text>
                    <Text>The Prize Pool for the contest will be increase or decrease based on the teams joining.</Text>
                    <Text>The Prize Pool for the contest will be increase or decrease based on the teams joining.</Text>
                 </View>
...
export default FlexibileContest
