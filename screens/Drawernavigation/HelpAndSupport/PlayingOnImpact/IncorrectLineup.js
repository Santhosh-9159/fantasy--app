          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>What happens if an incorrect starting 
                    lineup is officially announced?</Text>
                    <Text>Impact11 shares line-up information for specific matches from our trusted sources, but it is always recommended to double-check with official sources.</Text>
...
export default IncorrectLineup
