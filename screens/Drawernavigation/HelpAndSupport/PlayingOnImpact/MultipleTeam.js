...
<View style={{width:"100%",flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize:17}}>Playing on Impact11</Text>
                <Text style={{color:"#6F6F6F"}}>/ Managing Teams</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Can I join a Impact11 contest with multiple
                    teams?</Text>
                    <Text>The number of teams allowed per user depends on the type of contest.</Text>
                    <Text>Except "Head-to-Head" and "Winner Takes All" contests, you can join every other contest with multiple teams.</Text>
                    <Text>For example, you can join a Grand League with up to 20 teams. You will see the number of teams allowed per user shown next to “M” below "Total spots " on every contest card mentioned as “Upto 20” or “Upto 11”.</Text>
                    <Text>For example, you can join a Grand League with up to 20 teams. You will see the number of teams allowed per user shown next to “M” below "Total spots " on every contest card mentioned as “Upto 20” or “Upto 11”.</Text>
                    <Text>You can join each "Head-to-Head" and "Winner Takes All" contest with only one team.</Text>
