          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>What happens when one or more of my
                    selected players do not play in the match?</Text>
                    <Text>If the Player you selected didn’t play in a match, that played will not be awarded any points.</Text>
                    
                 </View>

                 <View style={{flexDirection:"row",gap:1}}>
                 <Text>Make sure you select announced player.</Text>
                 <Pressable>
...
export default PlayerDoNotPlay
