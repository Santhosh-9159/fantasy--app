          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>What are Public and Private contests</Text>
                    <Text>Public contests are open for all to join. </Text>
                    <Text>Private contests are created by the users. These private contests are only accessible to the users who have the unique code for the contest. You can create a private contest with a pre-defined number of participants and a predefined winning amount and Invite your friends with unique code.</Text>
...
export default PublicPrivateContest
