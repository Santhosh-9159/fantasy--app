          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Does unfilled public contest get cancelled?</Text>
                    <Text>Public contest(s) won’t get cancelled when:</Text>
                    <View style={{flexDirection:"column"}}>
                    <Text>2.Contest Card has Flexible tag in it </Text>
                    <Text>(In the case of Flexible public contests, the prize pool gets adjusted based on the number of spots that are filled)</Text>
                    </View>
                    <Text>3. 90% of total spots are filled in 6+ member contests.</Text>
...
export default UnfilledContest
