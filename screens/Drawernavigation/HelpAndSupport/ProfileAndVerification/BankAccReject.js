          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Why is my Bank account verification
                    getting rejected?</Text>
                    <Text>To verify your Bank account, you’ll have to verify your PAN first</Text>
                    <View style={{flexDirection:"column",width:"98%"}}>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Name on the bank proof uploaded matches the name on the PAN card</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Correct bank account number, IFSC code and name are updated in the form on the app</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Bank proof uploaded is a valid proof like a cancelled cheque, account statement, or passbook </Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Bank details like account number, IFSC code and name are clearly visible on the bank proof that you upload</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Details on the form and on the bank proof copy match each other</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Uploaded bank proof is not password protected </Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Entire bank account number is visible on the bank proof uploaded</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>No payment wallets are submitted. Payment banks are accepted.</Text>
                        </View>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>IFSC code belongs to the list of acceptable IFSC codes attached in this article</Text>
                        </View>
