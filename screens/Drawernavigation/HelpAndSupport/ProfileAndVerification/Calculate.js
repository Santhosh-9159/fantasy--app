          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How are My Matches and Contests
                    calculated?</Text>
                    <Text>If you created a team for a certain match, it counts as a Match Played in your Career Stats. Similarly, if you have joined one contest with 3 different teams, then it counts as 3 Contests Played in your career stats.</Text>                  
                 </View>
