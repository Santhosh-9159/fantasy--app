          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How to change my mobile number?</Text>
                    <Text>Go to 'My Info & Settings' from the side Navigation menu and click on the pencil icon on the mobile number field, enter the new mobile number, enter the new OTP you receive, and that's it!</Text>
                    <Text>Your new number is verified, and we'll send you a confirmation on your verified email ID.</Text>
                    <Text>A few things to remember while changing the mobile number:</Text>
                    <View style={{flexDirection:"column",width:"98%"}}>
                          <View style={{flexDirection:"row"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text>Your new mobile number is not linked to any other Impact11 account</Text>
                          </View>
                          <View style={{flexDirection:"row",alignItems:"center"}}>
                          <Entypo name="dot-single" size={24} color="black" />
                          <Text>You can change your mobile number thrice from the app</Text>
                          </View>
                    </View>
