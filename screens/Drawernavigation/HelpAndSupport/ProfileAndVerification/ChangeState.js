          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How to change my state?</Text>
                    <Text>Go to 'My Info & Settings' from the side navigation menu.</Text>
                    <Text>However, in case you have verified your KYC documents (i.e. Aadhaar/ Driving Licence/ Voter ID) on your Impact11 account, the State will be auto-picked based on this document and cannot be changed via the app.</Text>                       
                 </View>
