          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>I don’t have an Aadhar. How to complete
                    my verification?</Text>
                    <Text>Don't worry!</Text>
                    <Text>If you do not have an Aadhaar, you can also verify your Voter ID or Driving License.</Text>
                 </View>
