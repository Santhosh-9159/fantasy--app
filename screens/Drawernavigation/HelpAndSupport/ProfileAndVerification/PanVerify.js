          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Is PAN and bank verification mandatory?</Text>
                    <Text>Yes! Users need to verify their PAN and bank details for the following reasons.</Text>
                    <View style={{flexDirection:"column",width:"98%"}}>
                        <View style={{flexDirection:"row"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>Withdrawals involve transferring your winning amount to your bank account</Text>
                        </View>
                        <View style={{flexDirection:"row",alignItems:"center"}}>
                        <Entypo name="dot-single" size={24} color="black" />
                        <Text>To issue TDS certificates on time whenever applicable</Text>
                        </View>
                    </View>
                 </View>
