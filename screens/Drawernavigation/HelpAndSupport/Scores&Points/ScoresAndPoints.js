...
<View style={{width:"100%",flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:35}}>
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View>
                <Text style={{fontWeight:"bold",fontSize:15}}>Scores And Points</Text>
            </View>
            <View style={{flexDirection:"column",gap:10}}>
               ...
               <Pressable onPress={()=>navigation.navigate('PointsNotUpdated')}>
               <Text style={{color:"#6F6F6F"}}>My Points are not getting Updated, what should I do?</Text>
               </Pressable>
               <Pressable onPress={()=>navigation.navigate('PointsForSuperOver')}>
               <Text style={{color:"#6F6F6F"}}>Do I get Points for Super over?</Text>
               </Pressable>
               <Pressable onPress={()=>navigation.navigate('SubstitutePlayer')}>
               <Text style={{color:"#6F6F6F"}}>Do I get Points for a substitute player If replaces any
               fielder on Field?</Text>
               </Pressable>
