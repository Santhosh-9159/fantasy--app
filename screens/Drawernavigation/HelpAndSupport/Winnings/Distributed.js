...
<View style={{width:"100%",flexDirection:"column",display:"flex",justifyContent:"center",alignItems:"center",position:"relative",paddingTop:20,gap:15}}>
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            <View style={{flexDirection:"row",gap:5}}>
                <Text style={{fontWeight:"bold",fontSize:17}}>Winnings</Text>
            </View>
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>If there is a tie between user, how will the
                    winning be distributed?</Text>
                    <Text>In an event wherein there’s a tie between two or more users, the winnings are distributed between the users equally.</Text>
                    <Text>For example,</Text>
                    <Text>If the winning amount for Rank 1 is Rs.1000 and Rank 2 is Rs.500 and if two players have a tie at Rank1, total winnings of both 1sr and 2nd Rank will be split equally between two players.</Text>
                    <Text>            i.e. (1000+500)/2 = Rs.750, both players will win Rs.750 each.</Text>
