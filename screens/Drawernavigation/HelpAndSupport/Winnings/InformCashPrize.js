          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>How will I Informed if I win a cash Prize?</Text>
                    <Text>Final ranks and Points are updated immediately after the end of every match. If a user wins a cash prize in a contest(s), the winning amount will be credited automatically to the Impact11 wallet of the user</Text>
...
export default InformCashPrize
