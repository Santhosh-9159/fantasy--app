          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>When will I receive my winnings?</Text>
                    <Text>Usually within 4 hours after the match is completed and winners are declared!</Text>
                    <Text>For matches ending late at night, your winnings will be added to your Impact11 account the next morning after the match winners are declared..</Text>
