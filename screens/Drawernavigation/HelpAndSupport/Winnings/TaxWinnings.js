          ...
          <View style={{width:"90%",flexDirection:"column",display:"flex",justifyContent:"center",backgroundColor:"#fff",padding:15,gap:15}}>
            ...
            <View style={{flexDirection:"column",gap:40}}>
                 <View style={{flexDirection:"column",gap:15}}>
                    <Text style={{fontWeight:"bold",fontSize:17}}>Is Tax deducted on my Winnings?</Text>
                    <Text>No! Your winnings will be credited as-is. </Text>
                    <Text>As per the new Govt. Tax (TDS) law, effective 1st April 2023, TDS will be deducted at 30% of your taxable amount at the time of withdrawal.</Text>
